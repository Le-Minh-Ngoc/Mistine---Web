<div style="max-width:480px;margin:40px auto;background:#fff;padding:32px 28px 24px 28px;border-radius:16px;box-shadow:0 2px 16px #e3e8f0;">
    <h2 style="text-align:center;color:#1976d2;font-weight:700;margin-bottom:24px;letter-spacing:1px;">Thêm sản phẩm</h2>
    <form method="post" enctype="multipart/form-data" style="display:flex;flex-direction:column;gap:18px;">
        <div style="display:flex;flex-direction:column;gap:6px;">
            ...
            <input id="code" type="text" name="code" required style="padding:10px 14px;border:1px solid #ccc;border-radius:8px;">
        </div>
        <div style="display:flex;flex-direction:column;gap:6px;">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;">
            ...
            <input id="price" type="number" name="price" required style="padding:10px 14px;border:1px solid #ccc;border-radius:8px;">
        </div>
        <div style="display:flex;flex-direction:column;gap:6px;">
            <label for="stock" style="font-weight:500;text-align:left;">Tồn kho:</label>
            <input id="stock" type="number" name="stock" required style="padding:10px 14px;border:1px solid #ccc;border-radius:8px;">
        </div>
        <div style="display:flex;flex-direction:column;gap:6px;">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;">
            ...
            <textarea id="description" name="description" rows="4" style="padding:10px 14px;border:1px solid #ccc;border-radius:8px;"></textarea>
        </div>
        <div style="display:flex;flex-direction:column;gap:6px;">
            <label for="image" style="font-weight:500;text-align:left;">Ảnh:</label>
